                ...
                <div class="col-sm-12 col-md-3 col-lg-3">
                    ...
                    <div class="dashboard_tab_button" >
                        <ul  class="nav flex-column dashboard-list">
                            ...
                            <li><a href="#orders"  class="nav-link active">Riwayat Pesanan</a></li>
                            ...
                            <div class="table_page table-responsive">
                                <table>
                                    ...
                                    <tbody>
                                        <?php 
                                        $nomor = 1;
                                        $ambil = $conn->query("SELECT * from transaksi where id_pelanggan = '".$_SESSION['id_pelanggan']."' and status_trans ='Menunggu Pembayaran' OR id_pelanggan = '".$_SESSION['id_pelanggan']."' and status_trans ='Menunggu Konfirmasi'" ); 
