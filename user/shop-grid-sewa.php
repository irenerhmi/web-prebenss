                                                ...
                                                <div class="col-xl-4 col-sm-6 col-12">
                                                    ...
                                                    <div class="product-default-single border-around" data-aos="fade-up"  data-aos-delay="0">
                                                        <div class="product-img-warp">
                                                            <a href="product-details.php?ids=<?php echo $perproduk['id_produk'];?>" class="product-default-img-link">
                                                                <img src="../image/seller/<?php echo $perproduk['image'] ?>" alt="" class="product-default-img img-fluid">
                                                            </a>
                                                            <div class="product-action-icon-link">
                                                                <ul>
                                                                    <li><a href="product-details.php?ids=<?php echo $perproduk['id_produk'];?>"><i class="icon-eye"></i></a></li>
                                                                    <li><a href="sewa.php?ids=<?php echo $perproduk['id_produk'];?>&qtys=1;?>"><i class="icon-shopping-cart"></i></a></li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                        <div class="product-default-content">
                                                            <h6 class="product-default-link"><a href="product-details.php?ids=<?php echo $produk['id_produk'];?>"><?php echo $perproduk['nama_produk'] ?></a></h6>
