...
$sql = "select p.*, d.harga_jual from produk p
            INNER JOIN detail_penjualan d 
            ON p.id_produk=d.id_produk 
            where p.id_jenis = 1 limit 3 ";
                        ...
                        <div class="product-img-warp">
                            ...
                            <div class="product-action-icon-link">
                                <ul>
                                    ...
                                    <li><button><a href="" data-bs-toggle="modal" data-bs-target="#modalAddcart"><i class="icon-shopping-cart"></i></a></button></li>
                                </ul>
                            </div>
                        </div>
